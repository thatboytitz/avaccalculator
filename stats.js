...
heroAtk["Medieval Spider Woman"] =			[650,715,780,910,1040,1235,1430];
heroAtk["Wasp"] = 					[100,150,200,300,400,550,700];
heroAtk["Original Wasp"] =				[300,350,400,500,600,750,900];


var heroHP = [];
heroHP["Bucky"] = 					[1500,1680,1860,2220,2580,3120,3660];
heroHP["Captain America 2099"] =				[1350,1515,1680,2010,2340,2835,3330];
heroHP["Loki"] = 					[300,450,600,900,1200,1650,2100];
heroHP["Medieval Spider Woman"] =				[1950,2145,2340,2730,3120,3705,4290];
heroHP["Wasp"] =					[300,450,600,900,1200,1650,2100];
heroHP["Original Wasp"] =				[900,1050,1200,1500,1800,2250,2700];
...
heroType["Loki"] 						= 1;
heroType["Medieval Spider Woman"]			= 2;
heroType["Wasp"]						= 2;
